...
final class StrEdgeCaseTest extends TestCase
{
    ...
    public function testPadStartEdgeCases(): void
    {
        ...
        $this->assertSame(1000, $result->chars()->size(), 'Should pad to exactly the specified length');
        $this->assertStringEndsWith('Hello', $result->toString());

        $str = Str::of('Hello');
        $result = $str->padStart(7, '世');
        $this->assertSame(7, $result->chars()->size());
    ...
    public function testPadEndEdgeCases(): void
    {
        ...
        $this->assertSame(1000, $result->size(), 'Should pad to exactly the specified length');
    ...
    public function testRepeatEdgeCases(): void
    {
        ...
        $this->assertSame(10000, $result->size(), 'Should repeat exactly the specified number of times');

        $str = Str::of('世');
        $result = $str->repeat(5);
        $this->assertSame(5, $result->chars()->size());
    ...
    public function testNormalizeEdgeCases(): void
    {
        ...
        $this->assertEquals(4, $nfc->chars()->size(), 'NFC string should have length 4'); // "é" in composed form
        $this->assertEquals(5, $nfd->chars()->size(), 'NFD string should have length 5'); // "é" in decomposed form
        ...
        $this->assertEquals(4, $nfkc->chars()->size(), 'NFKC string should have length 4'); // "é" in composed form
        $this->assertEquals(5, $nfkd->chars()->size(), 'NFKD string should have length 5'); // "é" in decomposed form
