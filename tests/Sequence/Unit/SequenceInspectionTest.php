...
final class SequenceInspectionTest extends TestCase
{
    ...
    public function testEqWithObjectReferences(): void
    {
        ...
        $seq2 = Sequence::of($obj1, $obj2);
        $seq3 = Sequence::of($obj1, $obj3);
