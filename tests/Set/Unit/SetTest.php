...
class SetTest extends TestCase
{
    ...
    {
        $set = Set::of(1, 2, 3);
        $this->assertEquals(3, $set->size()->toInt());
    ...
    {
        $set = Set::of(1, 1, 2);
        $this->assertEquals(2, $set->size()->toInt());
    }
    ...
    public function testAddAndRemove(): void
    {
        ...
        $this->assertEquals(1, $set->size()->toInt());
    }
    ...
    public function testOperations(): void
    {
        ...
        $this->assertEquals(1, $intersection->size()->toInt());
        $this->assertTrue($intersection->contains(3));

        $difference = $set1->difference($set2); // 1, 2
        $this->assertEquals(2, $difference->size()->toInt());
